...
const staticPaths = [
  ...
  "/guides/how-to-create-amazon-product-images-using-chatgpt",
  "/guides/how-to-put-clothing-on-ai-model-without-changing-garment",
  "/guides/how-to-preserve-text-prints-embroidery-ai-product-images",
  "/guides/how-to-turn-phone-product-photo-into-professional-listing-image",
  "/case-studies",
  "/about",
  "/faq",
  "/methodology",
